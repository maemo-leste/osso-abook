#ifndef __OSSO_ABOOK_TYPES_H_INCLUDED__
#define __OSSO_ABOOK_TYPES_H_INCLUDED__
...
typedef struct _OssoABookTpAccountModel                 OssoABookTpAccountModel;
typedef struct _OssoABookTpAccountModelClass            OssoABookTpAccountModelClass;
typedef struct _OssoABookTpAccountSelector              OssoABookTpAccountSelector;
typedef struct _OssoABookTpAccountSelectorClass         OssoABookTpAccountSelectorClass;
...
typedef struct _OssoABookPlugin                         OssoABookPlugin;
typedef struct _OssoABookPluginClass                    OssoABookPluginClass;
typedef struct _OssoABookPluginManager                  OssoABookPluginManager;
typedef struct _OssoABookPluginManagerClass             OssoABookPluginManagerClass;
...
typedef struct _OssoABookPresenceLabel                  OssoABookPresenceLabel;
typedef struct _OssoABookPresenceLabelClass             OssoABookPresenceLabelClass;
...
#endif /* __OSSO_ABOOK_TYPES_H_INCLUDED__ */
