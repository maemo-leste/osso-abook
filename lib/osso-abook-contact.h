 ...
 *
 * VCard parameter name for adding alternate versions of the same user name
 * as the real user name can be different to the one inserted by the user
 * as normalization can happen.
 */
...
EVCardAttribute *
osso_abook_contact_find_matching_attribute (OssoABookContact *contact,
