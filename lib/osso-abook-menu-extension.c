...
#define OSSO_ABOOK_MENU_EXTENSION_PRIVATE(me) \
                ((OssoABookMenuExtensionPrivate *)osso_abook_menu_extension_get_instance_private(me))

static void
osso_abook_menu_extension_set_property(GObject *object, guint property_id, const GValue *value, GParamSpec *pspec)
{
