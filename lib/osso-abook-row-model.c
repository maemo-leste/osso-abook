...
{
  static gsize g_define_type_id__fence = 0;

  if (g_once_init_enter(&g_define_type_id__fence))
  {
    ...
    g_once_init_leave(&g_define_type_id__fence, g_define_type_id);
  }

  return g_define_type_id__fence;
}
