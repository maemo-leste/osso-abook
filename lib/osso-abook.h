...
#ifndef __OSSO_ABOOK_H__
#define __OSSO_ABOOK_H__
...
#include "osso-abook-speed-dial-settings-dialog.h"
#include "osso-abook-speed-dial-settings.h"
#endif

#endif /* __OSSO_ABOOK_H__ */
