#ifndef __OSSO_ABOOK_SETTINGS_H_INCLUDED__
#define __OSSO_ABOOK_SETTINGS_H_INCLUDED__
...
#define OSSO_ABOOK_SETTINGS_KEY_MAP_HELPER \
        "/apps/osso-addressbook/map-helper"
#define OSSO_ABOOK_SETTINGS_KEY_VIDEO_BUTTON \
        "/apps/osso-addressbook/video-button"
#define OSSO_ABOOK_SETTINGS_KEY_SMS_BUTTON \
        "/apps/osso-addressbook/sms-button"
...
char *
osso_abook_settings_get_map_helper            (void);

gboolean
osso_abook_settings_get_video_button          (void);

gboolean
osso_abook_settings_get_sms_button            (void);
...
gboolean
osso_abook_settings_set_map_helper            (const char           *helper);
...
#endif /* __OSSO_ABOOK_SETTINGS_H_INCLUDED__ */
